...
_DEFAULT_SPORT_KEYWORDS: Dict[str, List[str]] = {
    ...
    'mma': ['ufc', 'mma', 'bellator', 'one fc', 'pfl', 'grappling', 'flograppling'],
    'racing': ['racing', 'f1', 'formula 1', 'formula one', 'nascar', 'motogp', 'indycar', 'rally', 'floracing'],
...
SPORTS_GATE_TOKENS: tuple[str, ...] = (
    ...
    'cricket', 'tennis', 'hockey', 'racing', 'grappling', 'flofc', 'fight',
