...
from metatv.gui.menu_bar_reveal import _MenuBarRevealMixin
...
class MainWindow(_HistoryMixin, _ProviderMixin, _ProviderConnectivityMixin, _SeriesMixin, _ChannelListMixin, _StreamingMixin, _OverlaysMixin, _NavMixin, _MetadataMixin, _FavoritesMixin, _DownloadsMixin, _UpdatesMixin, _StyleMenuMixin, _AsyncMixin, _AppHeaderMixin, _FilterChipHostMixin, _MenuBarRevealMixin, _MenuActionsMixin, _CatalogRefreshTickMixin,
    ...
    def __init__(self, config: Config, config_recovered: bool = False):
        ...
        self.migration_manager.register(OfflineMetadataBackfillTask(self.db))
