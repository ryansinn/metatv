...
ENTRY = WhatsNewEntry(
    ...
    items=(
        ...
        "When you do want the full list, the strip at the top of the lens has "
        "\"See all in Search\", which closes the preview and filters the "
        "channel list — landing on the same titles the lens was showing.",
    ...
    test_steps=(
        ...
        "\"With <name>\", and a strip below it names the lens.",
        ...
        "Open a lens, then click \"See all in Search\" in the strip — the "
        "preview closes and the channel list shows a \"Cast/Crew: <name>\" "
        "(or \"Genre: <genre>\") chip listing the same titles.",
        "Click a name that appears in only one title you own — the strip says "
        "\"Nothing else with <name>\" and the preview stays where it is "
