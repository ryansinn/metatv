...
ENTRY = WhatsNewEntry(
    ...
    test_steps=(
        ...
        "Collapse EVERY section one at a time — Overview, Also Available, "
        "Cast, Technical Details, Tags, Similar Titles — and confirm each one "
        "actually hides its contents, not just flips its arrow.",
